...
export default function UserContent() {
  ...
  // Show loading state during SSR and until component is mounted
  ...
  // Now we can safely render based on user state
  if (!user) {
    return (
      <div className="mt-10">
        <div className="flex justify-center space-x-4">
  ...
  return (
    <div className="mt-10">
      ...
      {userInfo.isAdmin && (
        <p className="text-sm text-blue-600 mb-6">Role: {userInfo.role}</p>
      )}
      ...
      <div className="flex justify-center space-x-4">
        {userInfo.isAdmin ? (
          ...
          <p className="text-gray-600 px-8 py-3">
            Welcome to The Pensieve Index! Admin access requires special
            permissions.
          </p>
        )}
      </div>
